...
class Quantity(
    ...
    @overload
    def __mul__(self: Quantity[DT, Numpy1DArray], other: Quantity[Any, Any]) -> Quantity[Any, Numpy1DArray]: ...
    @overload
    def __mul__(self: Quantity[DT, pl.Series], other: Quantity[Any, Any]) -> Quantity[Any, pl.Series]: ...
    @overload
    def __mul__(self: Quantity[DT, pl.Expr], other: Quantity[Any, Any]) -> Quantity[Any, pl.Expr]: ...
    @overload
    ...
    @overload
    def __rmul__(self: Quantity[DT, Numpy1DArray], other: Quantity[Any, Any]) -> Quantity[Any, Numpy1DArray]: ...
    @overload
    def __rmul__(self: Quantity[DT, pl.Series], other: Quantity[Any, Any]) -> Quantity[Any, pl.Series]: ...
    @overload
    def __rmul__(self: Quantity[DT, pl.Expr], other: Quantity[Any, Any]) -> Quantity[Any, pl.Expr]: ...
    @overload
    ...
    @overload
    def __truediv__(self: Quantity[DT, Numpy1DArray], other: Quantity[Any, Any]) -> Quantity[Any, Numpy1DArray]: ...
    @overload
    def __truediv__(self: Quantity[DT, pl.Series], other: Quantity[Any, Any]) -> Quantity[Any, pl.Series]: ...
    @overload
    def __truediv__(self: Quantity[DT, pl.Expr], other: Quantity[Any, Any]) -> Quantity[Any, pl.Expr]: ...
    @overload
