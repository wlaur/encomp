...
def test_quantity_unspecified_type() -> None:
    ...
    reveal_type(Q(25, 'delta_°C'))  # R: encomp.units.Quantity[encomp.utypes.TemperatureDifference]
    ...
    reveal_type(Q(25, 'kJ/kg/degC'))  # R: encomp.units.Quantity[encomp.utypes.SpecificHeatCapacity]
    reveal_type(Q(25, 'kJ/kg/Δ°C'))  # R: encomp.units.Quantity[encomp.utypes.SpecificHeatCapacity]
    reveal_type(Q(25, 'J/kg/°C'))  # R: encomp.units.Quantity[encomp.utypes.SpecificHeatCapacity]
    ...
    reveal_type(Q(25, 'J') / Q(25, 'mol') / Q(25, 'delta_°C'))  # R: encomp.units.Quantity[encomp.utypes.MolarSpecificEntropy]
