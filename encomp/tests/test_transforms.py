...
def test_unset() -> None:
    ...
    assert_type(_times_2_unset(v), Q[UnknownDimensionality, Numpy1DArray])
...
def test_asdim() -> None:
    assert_type(_asdim(Q([25], "kg")), Q[Power, Numpy1DArray])
...
def test_dynamic_scalar() -> None:
    v = _dynamic_scalar(Q(25, "kg"), Q(25, "g"))  # pyrefly: ignore[bad-argument-type]
    assert_type(v, Q[Mass, float])  # pyrefly: ignore[assert-type]
