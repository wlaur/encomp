...
from typing import Generic, Union, Literal, Generator, Any, overload
...
# this instance is created via the CustomRegistry constructor
# however, it will be correctly set to a UnitRegistry class in the __init__ method
ureg: UnitRegistry
...
class Quantity(pint.quantity.Quantity, Generic[DT]):
    ...
    @overload
    def __new__(cls, val: Union[MagnitudeInput, Quantity[DT], str],  # type: ignore
                unit: HeatingValueUnits) -> Quantity[HeatingValue]:
        ...
    ...
    @overload
    def __rtruediv__(self: Quantity[HeatingValue], other: MagnitudeScalar  # type: ignore
    ...
    @overload
    def __mul__(self: Quantity[Mass], other: Quantity[MolarSpecificEntropy]  # type: ignore
    ...
    @overload
    def __mul__(self: Quantity[Time], other: Quantity[HeatingValue]  # type: ignore
                ) -> Quantity[KinematicViscosity]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[Substance], other: Quantity[MolarSpecificEntropy]  # type: ignore
                ) -> Quantity[HeatingValue]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[MassFlow], other: Quantity[HeatingValue]  # type: ignore
                ) -> Quantity[Power]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[Density], other: Quantity[HeatingValue]  # type: ignore
                ) -> Quantity[Pressure]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[DynamicViscosity], other: Quantity[HeatingValue]  # type: ignore
                ) -> Quantity[PowerPerLength]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[MolarMass], other: Quantity[HeatingValue]  # type: ignore
                ) -> Quantity[MolarSpecificEnthalpy]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[CurrencyPerEnergy], other: Quantity[HeatingValue]  # type: ignore
                ) -> Quantity[CurrencyPerMass]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[MassPerEnergy], other: Quantity[HeatingValue]  # type: ignore
                ) -> Quantity[Dimensionless]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[MolarSpecificEntropy], other: Quantity[Mass]  # type: ignore
                ) -> Quantity[MolarSpecificEnthalpy]:
        ...

    @overload
    def __mul__(self: Quantity[MolarSpecificEntropy], other: Quantity[Substance]  # type: ignore
                ) -> Quantity[HeatingValue]:
        ...
    ...
    @overload
    def __mul__(self: Quantity[HeatingValue], other: Quantity[Time]  # type: ignore
                ) -> Quantity[KinematicViscosity]:
        ...

    @overload
    def __mul__(self: Quantity[HeatingValue], other: Quantity[MassFlow]  # type: ignore
                ) -> Quantity[Power]:
        ...

    @overload
    def __mul__(self: Quantity[HeatingValue], other: Quantity[Density]  # type: ignore
                ) -> Quantity[Pressure]:
        ...

    @overload
    def __mul__(self: Quantity[HeatingValue], other: Quantity[DynamicViscosity]  # type: ignore
                ) -> Quantity[PowerPerLength]:
        ...

    @overload
    def __mul__(self: Quantity[HeatingValue], other: Quantity[MolarMass]  # type: ignore
                ) -> Quantity[MolarSpecificEnthalpy]:
        ...

    @overload
    def __mul__(self: Quantity[HeatingValue], other: Quantity[CurrencyPerEnergy]  # type: ignore
                ) -> Quantity[CurrencyPerMass]:
        ...

    @overload
    def __mul__(self: Quantity[HeatingValue], other: Quantity[MassPerEnergy]  # type: ignore
                ) -> Quantity[Dimensionless]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[Temperature]  # type: ignore
    ...
    @overload
    def __truediv__(self: Quantity[Dimensionless], other: Quantity[HeatingValue]  # type: ignore
                    ) -> Quantity[MassPerEnergy]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[Pressure], other: Quantity[HeatingValue]  # type: ignore
                    ) -> Quantity[Density]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[Energy], other: Quantity[HeatingValue]  # type: ignore
                    ) -> Quantity[Mass]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[Power], other: Quantity[HeatingValue]  # type: ignore
                    ) -> Quantity[MassFlow]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[KinematicViscosity], other: Quantity[HeatingValue]  # type: ignore
                    ) -> Quantity[Time]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[CurrencyPerMass], other: Quantity[HeatingValue]  # type: ignore
                    ) -> Quantity[CurrencyPerEnergy]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[PowerPerLength], other: Quantity[HeatingValue]  # type: ignore
                    ) -> Quantity[DynamicViscosity]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[Substance]  # type: ignore
                    ) -> Quantity[MolarSpecificEntropy]:
        ...

    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[Pressure]  # type: ignore
                    ) -> Quantity[SpecificVolume]:
        ...

    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[SpecificVolume]  # type: ignore
                    ) -> Quantity[Pressure]:
        ...

    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[Velocity]  # type: ignore
                    ) -> Quantity[Velocity]:
        ...

    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[KinematicViscosity]  # type: ignore
                    ) -> Quantity[Frequency]:
        ...

    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[Frequency]  # type: ignore
                    ) -> Quantity[KinematicViscosity]:
        ...

    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[MolarSpecificEntropy]  # type: ignore
                    ) -> Quantity[Substance]:
        ...

    @overload
    def __truediv__(self: Quantity[HeatingValue], other: Quantity[SpecificHeatCapacity]  # type: ignore
                    ) -> Quantity[Temperature]:
        ...

    @overload
    def __truediv__(self: Quantity[MolarSpecificEnthalpy], other: Quantity[Mass]  # type: ignore
                    ) -> Quantity[MolarSpecificEntropy]:
        ...
    ...
    @overload
    def __truediv__(self: Quantity[MolarSpecificEnthalpy], other: Quantity[HeatingValue]  # type: ignore
                    ) -> Quantity[MolarMass]:
        ...
