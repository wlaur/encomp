...
#     @overload
#     def __getitem__(
#         self: Quantity[Dimensionality, Numpy1DArray], index: int
#     ) -> Quantity[DT, float]: ...
...
#     ) -> Quantity[Currency, Numpy1DArray]: ...
#     @overload
#     def __new__(
...
#     ) -> Quantity[Temperature, Numpy1DArray]: ...
#     @overload
#     def __new__(
...
#     ) -> Quantity[Substance, Numpy1DArray]: ...
#     @overload
#     def __new__(
#         cls, val: list, unit: MolarMassUnits
#     ) -> Quantity[MolarMass, Numpy1DArray]: ...
#     @overload
#     def __new__(
...
#     ) -> Quantity[Current, Numpy1DArray]: ...
#     @overload
#     def __new__(
#         cls, val: list, unit: LuminosityUnits
#     ) -> Quantity[Luminosity, Numpy1DArray]: ...
#     @overload
...
#     ) -> Quantity[NormalVolume, Numpy1DArray]: ...
#     @overload
#     def __new__(
#         cls, val: list, unit: PressureUnits
#     ) -> Quantity[Pressure, Numpy1DArray]: ...
#     @overload
#     def __new__(
...
#     ) -> Quantity[Dimensionality, Numpy1DArray]: ...
